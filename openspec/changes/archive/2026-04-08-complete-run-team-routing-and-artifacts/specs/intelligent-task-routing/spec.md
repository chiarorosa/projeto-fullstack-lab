...
The system SHALL select the most suitable executable agent for each task based on semantic evaluation of agent `goal` and `backstory` against task intent.

#### Scenario: Multiple executable agents available
